...
@WebFilter(dispatcherTypes = {
		...
		, urlPatterns = {"/showquestions","/candidates","/rest/electionservice/readquestions"} )//Which URI's come through this filter
public class AuthFilter implements Filter {
	...
	public void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (!allowUser(auth)) {
            ...
            response.setHeader("WWW-Authenticate", "BASIC realm=\"Log into the admin services\"");
	...
	public void getUser() {
       ...
       //validUsers.put("nopass:","authorized");
        validUsers.put("sikli:kukkuu","authorized");
	}
